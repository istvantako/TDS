...
namespace TestDataSeeding.Client
{
    ...
    internal interface IEntityManager
    {
        ...
        void LoadEntities(List<EntityWithKey> entities, string path, bool useLock = false);
        ...
        void SaveEntities(List<EntityWithKey> entities, string path, bool useLock = false, bool overwrite = false);
    }
}
